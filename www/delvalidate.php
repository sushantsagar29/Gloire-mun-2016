...
if(strlen($postdata['preference'])<1){
$response .= "Empty Committee preference"."<br />";
$check = 0;
}
if(strlen($postdata['country1'])<1){
$response .= "Empty Country Preference 1"."<br />";
$check = 0;
}
if(strlen($postdata['country2'])<1){
$response .= "Empty Country Preference 2"."<br />";
$check = 0;
}
