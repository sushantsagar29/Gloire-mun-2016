...
$filename = "delegate-data.txt";//file setting
...
$query = "INSERT INTO delpayroll( pay_id,status,offer_title,name,email,contact,unit_price,quantity,amount,fees,currency,offer_slug,mac) 
						VALUES( ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
