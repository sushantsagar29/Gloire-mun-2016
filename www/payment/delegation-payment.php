...
<table class=".table-bordered" style='border: solid 1px black;width:4500px;'>
  ...
  <th>name</th><th>name2</th><th>name3</th><th>name4</th><th>name5</th><th>name6</th><th>name7</th>
  <th>email</th><th>Contact</th><th>Accommodation</th>
...
try {
     ...
     $stmt = $conn->prepare("SELECT * FROM delegationpayroll"); 
     $stmt->execute();
